...
public class BooksAdapter extends RecyclerView.Adapter<BooksAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        holder.txt_name_book.setText(data.get(position).getName());
        holder.txt_author_book.setText(data.get(position).getAuthor());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            txt_name_book = itemView.findViewById(R.id.name_book);
            txt_author_book = itemView.findViewById(R.id.author_book);
